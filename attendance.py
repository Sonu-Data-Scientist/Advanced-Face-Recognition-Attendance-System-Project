...
class Attendance:
    def __init__(self,root):
        ...
        left_inside_frame.place(x=0,y=135,width=1480,height=370)
        
        #label and entry
        #attendance id
         
        attendanceId=Label(left_inside_frame,text="AttendanceID:",font=("arial",13,"bold"),bg="white")
        attendanceId.grid(row=0,column=0,sticky=W,padx=10,pady=5)
